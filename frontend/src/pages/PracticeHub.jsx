      ...
      <div className="pt-[112px] max-w-[1400px] mx-auto px-6 md:px-12 pb-24 relative z-10">
        ...
        >
          ...
          <h1 className="font-display text-[52px] md:text-[72px] leading-[0.94] tracking-[-0.03em]">
            How will you <span className="font-display-italic text-shimmer">rehearse</span> today?
          </h1>
        </motion.div>
          ...
          {OPTIONS.map((o, i) => (
            ...
            >
              <Ripple className="block h-full">
                <Link
                  to={o.to}
                  className={`group flex flex-col justify-between h-full p-10 md:p-12 ${GLASS} hover:bg-[#f2ece0]/[0.08] hover:border-[#c68b73]/40 transition-all duration-500`}
                  data-testid={o.testid}
                >
                  <div>
                    <div className="flex items-center justify-between mb-10">
                      <span className="inline-flex items-center justify-center w-14 h-14 rounded-full border border-[#c68b73]/40 text-[#c68b73] group-hover:bg-[#c68b73] group-hover:text-[#0c0a09] transition-all duration-500">
                        <o.icon size={20} />
                      </span>
                      <span className="font-display italic text-5xl text-[#f2ece0]/20 group-hover:text-[#c68b73]/40 transition-colors">
                        {o.number}
                      </span>
                    </div>
                  ...
                  <div className="mt-10 inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.28em] text-[#c68b73] group-hover:text-[#f2ece0] transition-colors">
                    {o.cta}
